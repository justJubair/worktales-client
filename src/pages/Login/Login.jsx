...
const Login = () => {
  ...
  return (
    ...
    <div className="hero  ">
     <div>
         <h1 className="text-4xl font-bold text-center md:text-5xl md:mt-6 lg:my-8">Login <span className="text-[#4b1818]">now!</span></h1>
        ...
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
          <form onSubmit={handleLogin} className="card-body">
            ...
            <div className="form-control mt-6">
              <button type="submit" className="btn bg-[#4b1818] text-white hover:bg-[#350b0b]">Login</button>
            </div>
          </form>
